var chingAPI = [{
  ...
  "extra": "When all lines are nines, it means: There appears a flight of dragons without heads. Good fortune.",
  "lines": {
    "line": [
    "Nine at the beginning means: Hidden dragon. Do not act.",
    "Nine at the second place means: Dragon appearing in the field. It furthers one to see the great man.",
    "Nine at the third place means: All day long the superior man is creatively active. At nightfall his mind is still beset with cares. Danger. No blame.",
    "Nine at the fourth place means: Wavering flight over the depths. No blame.",
    "Nine at the fifth place means: Flying dragon in the heavens. It furthers one to see the great man.",
  ...
  "hexnum": "1" },
{
  ...
  "extra": "When all  lines are sixes, it means: Lasting perseverance furthers.",
  "lines": {
    "line": [
    ...
    "Six in the fourth place means: A tied-sack. No blame, no praise.",
  ...
  "hexnum": "2" },
{
  ...
  "pattern": "966696",
  "image": "Clouds and thunder:  image of Difficulty at the Beginning. Thus the superior man Brings order out of confusion.",
  "lines": {
    "line": [
    ...
    "Nine at the fifth place means: Difficulties in blessing. A little perseverance brings good fortune. Great perseverance brings misfortune.",
  ...
  "hexnum": "3" },
{
  "title": "Mng - Youthful Folly",
  "pattern": "696669",
  "image": "A spring wells  at the foot of the mountain:  of Youth. Thus the superior man fosters his character By thoroughness in all that he does.",
  "lines": {
    "line": [
    ...
    "Nine at the second place means: To bear with fools in kindliness brings good fortune. To know how to take women Brings good fortune. The son is capable of taking charge of the household.",
  ...
  "hexnum": "4" },
{
  "title": "Hsu - Waiting (Nourishment)",
  "pattern": "999696",
  "image": "Clouds rise to heaven: image of Waiting. Thus the superior man eats and drinks, Is joyous and of good cheer.",
  "lines": {
    "line": [
    "Nine at the beginning means: Waiting in the meadow. It furthers one to abide in what endures. No blame.",
    "Nine at the second place means: Waiting on the sand. There is some gossip. The end brings good fortune.",
    "Nine at the third place means: Waiting in the mud Brings about the arrival of the enemy.",
    "Six in the fourth place means: Waiting in blood. Get out of the pit.",
    "Nine at the fifth place means: Waiting at meat and drink. Perseverance brings good fortune.",
  ...
  "hexnum": "5" },
{
  "title": "Sung - Conflict",
  "pattern": "696999",
  "image": "Heaven and water go their opposite ways:  image of Conflict. Thus in all his transactions the superior man Carefully considers the beginning.",
  "lines": {
    "line": [
    "Six at the beginning means: If one does not perpetuate the affair, There is a little gossip. In the end, good fortune comes.",
    "Nine at the second place means: One cannot engage in conflict; One returns home, gives way. The people of his town, Three hundred households, Remain free of guilt.",
    ...
    "Nine at the fourth place means: One cannot engage in conflict. One turns back and submits to fate, Changes one's attitude, And finds peace in perseverance. Good fortune.",
    "Nine at the fifth place means: To contend before him Brings supreme good fortune.",
  ...
  "hexnum": "6" },
{
  "title": "Shih - The Army",
  "pattern": "696666",
  "image": "In the middle of the earth is water:  image of the Army. Thus the superior man increases his masses By generosity toward the people.",
  "lines": {
    "line": [
    "Six at the beginning means: An army must set forth in proper order. If the order is not good, misfortune threatens.",
    "Nine at the second place means: In the midst of the army. Good fortune. No blame. The king bestows a triple decoration.",
  ...
  "hexnum": "7" },
{
  ...
  "pattern": "666696",
  "image": "On the earth is water:  image of Holding Together. Thus the kings of antiquity Bestowed the different states as fiefs And cultivated friendly relations With the feudal lords.",
  "lines": {
    "line": [
    ...
    "Nine at the fifth place means: Manifestation of holding together. In the hunt the king uses beaters on three sides only And foregoes game that runs off in front. The citizens need no warning. Good fortune.",
  ...
  "hexnum": "8" },
{
  ...
  "pattern": "999699",
  "image": "The wind drives across heaven:  image of the Taming Power of the Small. Thus the superior man Refines the outward aspect of his nature.",
  "lines": {
    "line": [
    "Nine at the beginning means: Return to the way. How could there be blame in this? Good fortune.",
    "Nine at the second place means: He allows himself to be drawn into returning. Good fortune.",
    "Nine at the third place means: The spokes burst out of the wagon wheels. Man and wife roll their eyes.",
    "Six in the fourth place means: If you are sincere, blood vanishes and fear gives way. No blame.",
    "Nine at the fifth place means: If you are sincere and loyally attached, You are rich in your neighbor.",
  ...
  "hexnum": "9" },
{
  "title": "Lu - Treading [Conduct]",
  "pattern": "996999",
  "image": "Heaven above, the lake below: image of Treading. Thus the superior man discriminates between high and low, And thereby fortifies the thinking of the people.",
  "lines": {
    "line": [
    "Nine at the beginning means: Simple conduct. Progress without blame.",
    "Nine at the second place means: Treading a smooth, level course. The perseverance of a dark man Brings good fortune.",
    ...
    "Nine at the fourth place means: He treads on the tail of the tiger. Caution and circumspection Lead ultimately to good fortune.",
    "Nine at the fifth place means: Resolute conduct. Perseverance with awareness of danger.",
  ...
  "hexnum": "10" },
{
  "title": "T'ai - Peace",
  "pattern": "999666",
  "image": "Heaven and earth unite:  image of Peace. Thus the ruler Divides and completes the course of heaven and earth; He furthers and regulates the gifts of heaven and earth, And so aids the people.",
  "lines": {
    "line": [
    ...
    "Nine at the second place means: Bearing with the uncultured in gentleness, Fording the river with resolution, Not neglecting what is distant, Not regarding one's companions: Thus one may manage to walk in the middle.",
    "Nine at the third place means: No plain not followed by a slope. No going not followed by a return. He who remains persevering in danger Is without blame. Do not complain about this truth; Enjoy the good fortune you still possess.",
  ...
  "hexnum": "11" },
{
  ...
  "pattern": "666999",
  "image": "Heaven and earth do not unite:  image of Standstill. Thus the superior man falls back upon his inner worth In order to escape the difficulties. He does not permit himself to be honored with revenue.",
  "lines": {
    "line": [
    ...
    "Nine at the fourth place means: He who acts at the command of the highest Remains without blame. Those of like mind partake of the blessing.",
    "Nine at the fifth place means: Standstill is giving way. Good fortune for the great man. \"What if it should fail, what if it should fail?\" In this way he ties it to a cluster of mulberry shoots.",
  ...
  "hexnum": "12" },
{
  "title": "T'ung Jn - Fellowship with Men",
  "pattern": "969999",
  "image": "Heaven together with fire:  image of Fellowship with Men. Thus the superior man organizes the clans And makes distinctions between things.",
  "lines": {
    "line": [
    ...
    "Nine at the third place means: He hides weapons in the thicket; He climbs the high hill in front of it. For three years he does not rise up.",
    "Nine at the fourth place means: He climbs  on his wall; he cannot attack. Good fortune.",
    "Nine at the fifth place means: Men bound in fellowship first weep and lament, But afterward they laugh. After great struggles they succeed in meeting.",
  ...
  "hexnum": "13" },
{
  ...
  "pattern": "999969",
  "image": "Fire in heaven above:  image of Possession in Great Measure. Thus the superior man curbs evil and furthers good, And thereby obeys the benevolent will of heaven.",
  "lines": {
    "line": [
    ...
    "Nine at the second place means: A big wagon for loading. One may undertake something. No blame.",
    "Nine at the third place means: A prince offers it to the Son of Heaven. A petty man cannot do this.",
    "Nine at the fourth place means: He makes a difference Between himself and his neighbor. No blame.",
  ...
  "hexnum": "14" },
{
  ...
  "pattern": "669666",
  "image": "Within the earth, a mountain: image of Modesty. Thus the superior man reduces that which is too much, And augments that which is too little. He weighs things and makes them equal.",
  "lines": {
    "line": [
    ...
    "Nine at the third place means: A superior man of modesty and merit Carries things to conclusion. Good fortune.",
  ...
  "hexnum": "15" },
{
  "title": "Yu - Enthusiasm",
  "pattern": "666966",
  "image": "Thunder comes resounding out of the earth  of Enthusiasm. Thus the ancient kings made music In order to honor merit, And offered it with splendor To the Supreme Deity, Inviting their ancestors to be present.",
  "lines": {
    "line": [
    ...
    "Nine at the fourth place means: The source of enthusiasm. He achieves great things. Doubt not. You gather friends around you As a hair clasp gathers the hair.",
  ...
  "hexnum": "16" },
{
  "title": "Sui - Following",
  "pattern": "966996",
  "image": "Thunder in the middle of the lake: image of Following. Thus the superior man at nightfall Goes indoors for rest and recuperation.",
  "lines": {
    "line": [
    ...
    "Nine at the fourth place means: Following creates success. Perseverance brings misfortune. To go one's way with sincerity brings clarity. How could there be blame in this?",
    "Nine at the fifth place means: Sincere in the good. Good fortune.",
  ...
  "hexnum": "17" },
{
  "title": "Ku - Work on What Has Been Spoiled [Decay]",
  "pattern": "699669",
  "image": "The wind blows low on the mountain image of Decay. Thus the superior man stirs  the people And strengthens their spirit.",
  "lines": {
    "line": [
    "Six at the beginning means: Setting right what has been spoiled by the father. If there is a son, No blame rests upon the departed father. Danger. In the end good fortune.",
    "Nine at the second place means: Setting right what has been spoiled by the mother. One must not be too persevering.",
    "Nine at the third place means: Setting right what has been spoiled by the father. There will be little remorse. No great blame.",
  ...
  "hexnum": "18" },
{
  "title": "Lin - Approach",
  "pattern": "996666",
  "image": "The earth above the lake: image of Approach. Thus the superior man is inexhaustible In his will to teach, And without limits In his tolerance and protection of the people.",
  "lines": {
    "line": [
    "Nine at the beginning means: Joint approach. Perseverance brings good fortune.",
    "Nine at the second place means: Joint approach. Good fortune. Everything furthers.",
  ...
  "hexnum": "19" },
{
  "title": "Kuan - Contemplation (View)",
  "pattern": "666699",
  "image": "The wind blows over the earth Image of Contemplation. Thus the kings of old visited the regions of the world, Contemplated the people, And gave them instruction.",
  "lines": {
    "line": [
    ...
    "Nine at the fifth place means: Contemplation of my life. The superior man is without blame.",
    "Nine at the top means: Contemplation of his life. The superior man is without blame."] },


  "judgement": "Contemplation. The ablution has been made, But not yet the offering. Full of trust they look  to him.",
  "below": "K'un   The Receptive, Earth",
  "above": "Sun    The Gentle, Wind",
  "hexnum": "20" },
{
  ...
  "pattern": "966969",
  "image": "Thunder and lightning:  image of Biting Through. Thus the kings of former times made firm the laws Through clearly defined penalties.",
  "lines": {
    "line": [
    ...
    "Nine at the fourth place means: Bites on dried gristly meat. Receives metal arrows. It furthers one to be mindful of difficulties And to be persevering. Good fortune.",
  ...
  "hexnum": "21" },
{
  "title": "Pi - Grace",
  "pattern": "969669",
  "image": "Fire at the foot of the mountain Image of Grace. Thus does the superior man proceed When clearing current affairs. But he dare not decide controversial issues in this way.",
  "lines": {
    "line": [
    ...
    "Nine at the third place means: Graceful and moist. Constant perseverance brings good fortune.",
  ...
  "hexnum": "22" },
{
  ...
  "lines": {
    ...
    "Six in the fourth place means: The bed is split to the skin. Misfortune.",
  ...
  "hexnum": "23" },
{
  "title": "Fu - Return (The Turning Point)",
  "pattern": "966666",
  ...
  "hexnum": "24" },
{
  "title": "Wu Wang - Innocence (The Unexpected)",
  "pattern": "966999",
  ...
  "lines": {
    ...
    "Nine at the fourth place means: He who can be persevering Remains without blame.",
    "Nine at the fifth place means: Use no medicine in an illness Incurred through no fault of your own. It will pass of itself.",
  ...
  "hexnum": "25" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: The axletrees are taken from the wagon.",
    "Nine at the third place means: A good horse that follows others. Awareness of danger, With perseverance, furthers. Practice chariot driving and armed defense daily. It furthers one to have somewhere to go.",
  ...
  "hexnum": "26" },
{
  ...
  "hexnum": "27" },
{
  "title": "Ta Kuo - Preponderance of the Great",
  "pattern": "699996",
  ...
  "lines": {
    ...
    "Nine at the second place means: A dry poplar sprouts at the root. An older man takes a young wife. Everything furthers.",
    "Nine at the third place means: The ridgepole sags to the breaking point. Misfortune.",
    "Nine at the fourth place means: The ridgepole is braced. Good fortune. If there are ulterior motives, it is humiliating.",
    "Nine at the fifth place means: A withered poplar puts forth flowers. An older woman takes a husband. No blame. No praise.",
  ...
  "hexnum": "28" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: The abyss is dangerous. One should strive to attain small things only.",
    "Six in the third place means: Forward and backward, abyss on abyss. In danger like this, pause at first and wait, Otherwise you will fall into a pit in the abyss. Do not act in this way.",
    ...
    "Nine at the fifth place means: The abyss is not filled to overflowing, It is filled only to the rim. No blame.",
  ...
  "hexnum": "29" },
{
  ...
  "lines": {
    ...
    "Nine at the third place means: In the light of the setting sun, Men either beat the pot and sing Or loudly bewail the approach of old age. Misfortune.",
    "Nine at the fourth place means: Its coming is sudden; It flames up, dies down, is thrown away.",
  ...
  "hexnum": "30" },
{
  "title": "Hsien - Influence (Wooing)",
  "pattern": "669996",
  "image": "A lake on the mountain Image of Influence. Thus the superior man encourages people to approach him By his readiness to receive them.",
  "lines": {
    "line": [
    ...
    "Nine at the third place means: The influence shows itself in the thighs. Holds to that which follows it. To continue is humiliating.",
    "Nine at the fourth place means: Perseverance brings good fortune. Remorse disappears. If a man is agitated in mind, And his thoughts go hither and thither, Only those friends On whom he fixes his conscious thoughts Will follow.",
    "Nine at the fifth place means: The influence shows itself in the back of the neck. No remorse.",
  ...
  "hexnum": "31" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: Remorse disappears.",
    "Nine at the third place means: He who does not give duration to his character Meets with disgrace. Persistent humiliation.",
    "Nine at the fourth place means: No game in the field.",
  ...
  "hexnum": "32" },
{
  ...
  "lines": {
    ...
    "Nine at the third place means: A halted retreat Is nerve-wracking and dangerous. To retain people as men- and maidservants Brings good fortune.",
    "Nine at the fourth place means: Voluntary retreat brings good fortune to the superior man And downfall to the inferior man.",
    "Nine at the fifth place means: Friendly retreat. Perseverance brings good fortune.",
  ...
  "hexnum": "33" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: Perseverance brings good fortune.",
    "Nine at the third place means: The inferior man works through power. The superior man does not act thus. To continue is dangerous. A goat butts against a hedge And gets its horns entangled.",
    "Nine at the fourth place means: Perseverance brings good fortune. Remorse disappears. The hedge opens; there is no entanglement. Power depends upon the axle of a big cart.",
  ...
  "hexnum": "34" },
{
  ...
  "lines": {
    ...
    "Nine at the fourth place means: Progress like a hamster. Perseverance brings danger.",
  ...
  "hexnum": "35" },
{
  "title": "Ming I - Darkening of the Light",
  "pattern": "969666",
  ...
  "lines": {
    ...
    "Nine at the third place means: Darkening of the light during the hunt in the south. Their great leader is captured. One must not expect perseverance too soon.",
    ...
    "Six at the top means: Not light but darkness. First he climbed  to heaven, Then he plunged into the depths of the earth."] },
  ...
  "hexnum": "36" },
{
  "title": "Chia Jn - The Family [The Clan]",
  "pattern": "969699",
  ...
  "lines": {
    ...
    "Nine at the third place means: When tempers flare  in the family, Too great severity brings remorse. Good fortune nonetheless. When woman and child dally and laugh, It leads in the end to humiliation.",
    "Six in the fourth place means: She is the treasure of the house. Great good fortune.",
    "Nine at the fifth place means: As a king he approaches his family. Fear not. Good fortune.",
  ...
  "hexnum": "37" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: One meets his lord in a narrow street. No blame.",
    ...
    "Nine at the fourth place means: Isolated through opposition, One meets a like-minded man With whom one can associate in good faith. Despite the danger, no blame.",
  ...
  "hexnum": "38" },
{
  ...
  "lines": {
    ...
    "Nine at the third place means: Going leads to obstructions; Hence he comes back.",
    "Six in the fourth place means: Going leads to obstructions, Coming leads to union.",
    "Nine at the fifth place means: In the midst of the greatest obstructions, Friends come.",
  ...
  "hexnum": "39" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: One kills three foxes in the field And receives a yellow arrow. Perseverance brings good fortune.",
    ...
    "Nine at the fourth place means: Deliver yourself from your great toe. Then the companion comes, And him you can trust.",
  ...
  "hexnum": "40" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: Perseverance furthers. To undertake something brings misfortune. Without decreasing oneself, One is able to bring increase to others.",
    ...
    "Six in the fourth place means: If a man decreases his faults, It makes the other hasten to come and rejoice. No blame.",
  ...
  "hexnum": "41" },
{
  "title": "I - Increase",
  "pattern": "966699",
  "image": "Wind and thunder Image of Increase. Thus the superior man: If he sees good, he imitates it; If he has faults, he rids himself of them.",
  "lines": {
    "line": [
    ...
    "Nine at the fifth place means: If in truth you have a kind heart, ask not. Supreme good fortune. Truly, kindness will be recognized as your virtue.",
  ...
  "hexnum": "42" },
{
  "title": "Kuai - Break-through (Resoluteness)",
  "pattern": "999996",
  ...
  "lines": {
    ...
    "Nine at the second place means: A cry of alarm. Arms at evening and at night. Fear nothing.",
    "Nine at the third place means: To be powerful in the cheekbones Brings misfortune. The superior man is firmly resolved. He walks alone and is caught in the rain. He is bespattered, And people murmur against him. No blame.",
    "Nine at the fourth place means: There is no skin on his thighs, And walking comes hard. If a man were to let himself be led like a sheep, Remorse would disappear. But if these words are heard They will not be believed.",
    "Nine at the fifth place means: In dealing with weeds, Firm resolution is necessary. Walking in the middle Remains free of blame.",
  ...
  "hexnum": "43" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: There is a fish in the tank. No blame. Does not further guests.",
    "Nine at the third place means: There is no skin on his thighs, And walking comes hard. If one is mindful of the danger, No great mistake is made.",
    "Nine at the fourth place means: No fish in the tank. This leads to misfortune.",
    "Nine at the fifth place means: A melon covered with willow leaves. Hidden lines. Then it drops down to one from heaven.",
  ...
  "hexnum": "44" },
{
  "title": "Ts'ui - Gathering Together [Massing]",
  "pattern": "666996",
  ...
  "lines": {
    ...
    "Nine at the fourth place means: Great good fortune. No blame.",
    "Nine at the fifth place means: If in gathering together one has position, This brings no blame. If there are some who are not yet sincerely in the work, Sublime and enduring perseverance is needed. Then remorse disappears.",
  ...
  "hexnum": "45" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: If one is sincere, It furthers one to bring even a small offering. No blame.",
    "Nine at the third place means: One pushes upward into an empty city.",
  ...
  "hexnum": "46" },
{
  "title": "K'un - Oppression (Exhaustion)",
  "pattern": "696996",
  ...
  "lines": {
    ...
    "Nine at the second place means: One is oppressed while at meat and drink. The man with the scarlet knee bands is just coming. It furthers one to offer sacrifice. To set forth brings misfortune. No blame.",
    "Six in the third place means: A man permits himself to be oppressed by stone, And leans on thorns and thistles. He enters his house and does not see his wife. Misfortune.",
    "Nine at the fourth place means: He comes very quietly, oppressed in a golden carriage. Humiliation, but the end is reached.",
    "Nine at the fifth place means: His nose and feet are cut off. Oppression at the hands of the man with the purple knee bands. Joy comes softly. It furthers one to make offerings and libations.",
  ...
  "hexnum": "47" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: At the wellhole one shoots fishes. The jug is broken and leaks.",
    "Nine at the third place means: The well is cleaned, but no one drinks from it. This is my heart's sorrow, For one might draw from it. If the king were clear-minded, Good fortune might be enjoyed in common.",
    "Six in the fourth place means: The well is being lined. No blame.",
    "Nine at the fifth place means: In the well there is a clear, cold spring From which one can drink.",
  ...
  "hexnum": "48" },
{
  "title": "Ko - Revolution (Molting)",
  "pattern": "969996",
  "image": "Fire in the lake Image of Revolution. Thus the superior man Sets the calendar in order And makes the seasons clear.",
  "lines": {
    "line": [
    ...
    "Nine at the third place means: Starting brings misfortune. Perseverance brings danger. When talk of revolution has gone the rounds three times, One may commit himself, And men will believe him.",
    "Nine at the fourth place means: Remorse disappears. Men believe him. Changing the form of government brings good fortune.",
    "Nine at the fifth place means: The great man changes like a tiger. Even before he questions the oracle He is believed.",
  ...
  "hexnum": "49" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: There is food in the ting. My comrades are envious, But they cannot harm me. Good fortune.",
    "Nine at the third place means: The handle of the ting is altered. One is impeded in his way of life. The fat of the pheasant is not eaten. Once rain falls, remorse is spent. Good fortune comes in the end.",
    "Nine at the fourth place means: The legs of the ting are broken. The prince's meal is spilled And his person is soiled. Misfortune.",
  ...
  "hexnum": "50" },
{
  "title": "Chn - The Arousing (Shock, Thunder)",
  "pattern": "966966",
  ...
  "lines": {
    ...
    "Six in the second place means: Shock comes bringing danger. A hundred thousand times You lose your treasures And must climb the nine hills. Do not go in pursuit of them. After seven days you will get them back.",
    ...
    "Nine at the fourth place means: Shock is mired.",
  ...
  "hexnum": "51" },
{
  "title": "Kn - Keeping Still, Mountain",
  "pattern": "669669",
  ...
  "lines": {
    ...
    "Nine at the third place means: Keeping his hips still. Making his sacrum stiff. Dangerous. The heart suffocates.",
  ...
  "hexnum": "52" },
{
  "title": "Chien - Development (Gradual Progress)",
  "pattern": "669699",
  ...
  "lines": {
    ...
    "Nine at the third place means: The wild goose gradually draws near the plateau. The man goes forth and does not return. The woman carries a child but does not bring it forth. Misfortune. It furthers one to fight off robbers.",
    "Six in the fourth place means: The wild goose gradually draws near the tree. Perhaps it will find a flat branch. No blame.",
    "Nine at the fifth place means: The wild goose gradually draws near the summit. For three years the woman has no child. In the end nothing can hinder her. Good fortune.",
  ...
  "hexnum": "53" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: A one-eyed man who is able to see. The perseverance of a solitary man furthers.",
    "Six in the third place means: The marrying maiden as a slave. She marries as a concubine.",
    "Nine at the fourth place means: The marrying maiden draws out the allotted time. A late marriage comes in due course.",
    "Six in the fifth place means: The sovereign I gave his daughter in marriage. The embroidered garments of the princess Were not as gorgeous As those of the servingmaid. The moon that is nearly full Brings good fortune.",
  ...
  "hexnum": "54" },
{
  ...
  "lines": {
    ...
    "Nine at the third place means: The underbrush is of such abundance That the small stars can be seen at noon. He breaks his right arm. No blame.",
    "Nine at the fourth place means: The curtain is of such fullness That the polestars can be seen at noon. He meets his ruler, who is of like kind. Good fortune.",
  ...
  "hexnum": "55" },
{
  ...
  "lines": {
    ...
    "Nine at the third place means: The wanderer's inn burns down. He loses the steadfastness of his young servant. Danger.",
    "Nine at the fourth place means: The wanderer rests in a shelter. He obtains his property and an ax. My heart is not glad.",
  ...
  "hexnum": "56" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: Penetration under the bed. Priests and magicians are used in great number. Good fortune. No blame.",
    "Nine at the third place means: Repeated penetration. Humiliation.",
    "Six in the fourth place means: Remorse vanishes. During the hunt Three kinds of game are caught.",
    "Nine at the fifth place means: Perseverance brings good fortune. Remorse vanishes. Nothing that does not further. No beginning, but an end. Before the change, three days. After the change, three days. Good fortune.",
  ...
  "hexnum": "57" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: Sincere joyousness. Good fortune. Remorse disappears.",
    "Six in the third place means: Coming joyousness. Misfortune.",
    "Nine at the fourth place means: Joyousness that is weighed is not at peace. After ridding himself of mistakes a man has joy.",
    "Nine at the fifth place means: Sincerity toward disintegrating influences is dangerous.",
  ...
  "hexnum": "58" },
{
  "title": "Huan - Dispersion [Dissolution]",
  "pattern": "696699",
  ...
  "lines": {
    ...
    "Nine at the second place means: At the dissolution He hurries to that which supports him. Remorse disappears.",
    ...
    "Nine at the fifth place means: His loud cries are as dissolving as sweat. Dissolution. A king abides without blame.",
  ...
  "hexnum": "59" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: Not going out of the gate and the courtyard Brings misfortune.",
    ...
    "Nine at the fifth place means: Sweet limitation brings good fortune. Going brings esteem.",
  ...
  "hexnum": "60" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: A crane calling in the shade. Its young answers it. I have a good goblet. I will share it with you.",
    ...
    "Nine at the fifth place means: He possesses truth, which links together. No blame.",
  ...
  "hexnum": "61" },
{
  "title": "Hsiao Kuo - Preponderance of the Small",
  "pattern": "669966",
  ...
  "lines": {
    ...
    "Nine at the third place means: If one is not extremely careful, Somebody may come from behind and strike him. Misfortune.",
    "Nine at the fourth place means: No blame. He meets him without passing by. Going brings danger. One must be on guard. Do not act. Be constantly persevering.",
  ...
  "hexnum": "62" },
{
  "title": "Chi Chi - After Completion",
  "pattern": "969696",
  ...
  "lines": {
    "line": [
    "Nine at the beginning means: He brakes his wheels. He gets his tail in the water. No blame.",
    ...
    "Nine at the third place means: The Illustrious Ancestor Disciplines the Devil's Country. After three years he conquers it. Inferior people must not be employed.",
    "Six in the fourth place means: The finest clothes turn to rags. Be careful all day long.",
    "Nine at the fifth place means: The neighbor in the east who slaughters an ox Does not attain as much real happiness As the neighbor in the west With his small offering.",
  ...
  "hexnum": "63" },
{
  ...
  "lines": {
    ...
    "Nine at the second place means: He brakes his wheels. Perseverance brings good fortune.",
    "Six in the third place means: Before completion, attack brings misfortune. It furthers one to cross the great water.",
    "Nine at the fourth place means: Perseverance brings good fortune. Remorse disappears. Shock, thus to discipline the Devil's Country. For three years, great realms are awarded.",
